...
int main(void)
{
    ...
    printf("\n Testing replace \n");
    replace(addresses, "Don", "gregory.franks@carleton.ca");
    replace(addresses, "Babak", "gregory.franks@carleton.ca");
    replace(addresses, "Lynn", "gregory.franks@carleton.ca");
    replace(addresses, "Jason", "lynn.marshall@carleton.ca");
    print_dictionary(addresses);
